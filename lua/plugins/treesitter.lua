local treesitter_opts = {
	...
	highlight = {
		...
		-- Disable a list of parser names for highlig. You can also
		-- use a lua function. See an example for diabling the
		-- highlighting for large files in the README of the module.
		disable = { "" },
		--[[ custom_captures = { ]]
	...
	indent = {
		-- use treesitter for = opreator (indent)
		enable = true,
		disable = { "yaml" },
	},
	autopairs = {
...
local treesitter_textobjects_opts = {
	textobjects = {
		...
		swap = {
			-- swap nodes of the treesitter AST
			enable = true,
			swap_next = {
...
local M = {
	...
	},
	{
		"nvim-treesitter/nvim-treesitter-textobjects",
		config = function()
			require("nvim-treesitter.configs").setup(treesitter_textobjects_opts)
